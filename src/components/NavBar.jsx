            ...
            <ul className='flex items-center justify-between'>
                ...
                <div className='flex gap-6 items-center'>
                    <div 
                        ...
                        onClick={toggleMenu}
                    >
                        <div className={`line-1 absolute w-[70%] h-[2.5px] bg-black left-[15%] top-[30%] transition-all duration-300 ease-out ${menuOpen ? '' : ''}`}></div>
                        <div className={`line-2 absolute w-[70%] h-[2.5px] bg-black left-[15%] top-[50%] transition-all duration-300 ease-out ${menuOpen ? '' : ''}`}></div>
                        <div className={`line-3 absolute w-[70%] h-[2.5px] bg-black left-[15%] top-[70%] transition-all duration-300 ease-out ${menuOpen ? 'opacity-0' : ''}`}></div>
                    </div>
                    {/* Tablet/Desktop */}
