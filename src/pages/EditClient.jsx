...
export default function EditClient() {
    ...
    const handleFetchClient = (e) => {
        e.preventDefault();
        axios.get(`https://api-project-register.vercel.app/api/clients/${clientId}`)
            .then((response) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        console.log('Enviando dados:', client); 
        axios.put(`https://api-project-register.vercel.app/api/clients/${clientId}`, client)
            .then((response) => {
    ...
    const handleDeleteClient = () => {
        axios.delete(`https://api-project-register.vercel.app/api/clients/${clientId}`)
            .then((response) => {
